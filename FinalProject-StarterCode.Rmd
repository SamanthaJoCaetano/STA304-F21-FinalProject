...
<Note: Please change the keywords to better describe your data and analysis. (At the very least you should fix that typo.) For example you may want to include "Causal Inference", the specific method used (e.g., "Propensity Score Matching") and some other words which describe your data.>
