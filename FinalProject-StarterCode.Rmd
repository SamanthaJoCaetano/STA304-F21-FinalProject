...
<Note: Please change the keywords to better describe your data and analysis. (At the very least you should fix the typo in algorithm.) For example you may want to include "Causal Inference", the specific method used (e.g., "Propensity Score Matching") and some other words which describe your data.>
...
<Optional: If you include an image _not_ created in R, you MUST make sure that you provide the file with your upload. You will lose reproducibility marks if we can't recreate your report and this includes external images. The scale command changes the size.>
...
<Be sure to number and label these images and be sure to include a a citation in your bibliography for any external images that are not your property.>
...
<Here you should include a description of at least two ethical considerations that you had made within this report. Some examples include: reproducibility, transparency, using open data, publication bias, verifying assumptions, not p-hacking, gender vs sex, survey design/testing (e.g., avoiding leading questions, avoiding bias), privacy concerns, algorithmic bias, properly citing in your bibliography, etc.>
